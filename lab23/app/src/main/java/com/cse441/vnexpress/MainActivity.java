...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main); // Đảm bảo layout này có ListView với id 'lv1'
        lv1 = (ListView) findViewById(R.id.lv1);
        mylist = new ArrayList<>();
        // Đảm bảo bạn có file layout 'R.layout.lstview' cho mỗi hàng
                    ...
                    switch (eventType) {
                        ...
                        case XmlPullParser.START_TAG:
                            ...
                            if (nodeName.equals("title")) {
                                ...
                                try {
                                    url1Str = description.substring(description.indexOf("src=") + 5,
                                ...
                                try {
                                    URL newurl = new URL(url1Str.toString() + "");
