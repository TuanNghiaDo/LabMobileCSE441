...
// Giả sử bạn đã tạo file R.java và Tygia.java
// import com.yourpackage.R;
// import com.yourpackage.Tygia;
...
public class MyArrayAdapter extends ArrayAdapter<Tygia> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txtBanTM.setText(tygia.getBantienmat()); // Lưu ý: Tên phương thức này có thể bị gõ nhầm
